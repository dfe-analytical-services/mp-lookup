...
LAD codes include both 2024 and 2025 variants, as not everywhere is using 2025 yet. A handful of LADs change code (but not name), for example Sheffield changed from `E08000019` to `E08000039` [ONS LAD changes 2024 - 2025](https://geoportal.statistics.gov.uk/datasets/40d74f80a6cb49f68fdd9fa53efbb1dd_0/explore?filters=eyJMQUQyNE5NIjpbIlNoZWZmaWVsZCJdfQ%3D%3D), though on GIAS (source for the 3 digit LA codes), Sheffield is still listed under the 2024 code.
